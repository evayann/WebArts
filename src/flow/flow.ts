// Implemented from https://www.dwitter.net/d/21637
...
let spaceOffset: number = 3.8;
let sizeFactor: number = 1;
let density: number = 2000;
...
function setupDatGUI(): void {
    ...
    guiEffect
        .add(params, "spaceOffset",0, 5, .1)
        .onChange(value => spaceOffset = value);
    guiEffect
        .add(params, "density",500, 5000, 10)
